...
class ViThu extends BossMain {
	...
	public function __construct(Level $level, CompoundTag $nbt){
		...
		$skin = Boss::getInstance()->getManager()->getSkin($skindata);
    	$this->setSkin($skin);
...
/*		return TextFormat::BOLD.  TextFormat::GRAY . "§l§c❤ " . TextFormat::GREEN . str_repeat("|", $progress) .
			TextFormat::RED . str_repeat("|", $size - $progress) . "".
			TextFormat::AQUA . " {$percentage}%";*/

		return TextFormat::BOLD.  TextFormat::GRAY . "§l§c❤§a {$percentage}%";
	}
