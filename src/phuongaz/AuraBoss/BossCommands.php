...
class BossCommands extends Command implements Listener {
	...
	public function execute(CommandSender $sender, string $label, array $args):bool {
		...
		if(isset($args[0]) and $args[0] == 'spawn-all'){
			Server::getInstance()->dispatchCommand(new ConsoleCommandSender(),"rca ".$sender->getName(). " khu b1");
			sleep(0.5);
			Server::getInstance()->dispatchCommand(new ConsoleCommandSender(),"rca ".$sender->getName(). " khu b2");
			sleep(0.5);
			Server::getInstance()->dispatchCommand(new ConsoleCommandSender(),"rca ".$sender->getName(). " khu b3");
			sleep(0.5);
			Server::getInstance()->dispatchCommand(new ConsoleCommandSender(),"rca ".$sender->getName(). " khu b4");
			sleep(0.5);
			Server::getInstance()->dispatchCommand(new ConsoleCommandSender(),"rca ".$sender->getName(). " khu b5");
			sleep(0.5);
			Server::getInstance()->dispatchCommand(new ConsoleCommandSender(),"rca ".$sender->getName(). " khu b6");
			sleep(0.5);
			Server::getInstance()->dispatchCommand(new ConsoleCommandSender(),"rca ".$sender->getName(). " khu hub");
			sleep(0.5);
